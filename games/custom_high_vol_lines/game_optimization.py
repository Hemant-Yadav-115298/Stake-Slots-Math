        ...
        self.game_config.opt_params = {
            "base": {
                ...
                "scaling": ConstructScaling(
                    [
                        {"criteria": "basegame", "scale_factor": 1.2, "win_range": (100, 200), "probability": 1.0},
                        {"criteria": "basegame", "scale_factor": 1.5, "win_range": (1000, 2000), "probability": 1.0},
                        {
                            "criteria": "freegame",
                            "scale_factor": 0.8,
                            "win_range": (100000, 200000),
                            "probability": 1.0,
                        },
                        {
                            "criteria": "freegame",
                            "scale_factor": 1.2,
                            "win_range": (300000, 400000),
                            "probability": 1.0,
                        },
                    ]
                ).return_dict(),
