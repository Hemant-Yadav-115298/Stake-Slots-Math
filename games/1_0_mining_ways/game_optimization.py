...
class OptimizationSetup:
    ...
    def __init__(self, game_config):
        ...
        self.game_config.opt_params = {
            ...
            "base": {
                "conditions": {
                    # Wincap criteria - maximum win simulations
                    ...
                    # Base game criteria - remaining RTP (~58%)
            ...
            "bonus_fs": {
                "conditions": {
                    "wincap": ConstructConditions(
                        rtp=0.01,
                        av_win=wincaps["bonus_fs"],
                        search_conditions=wincaps["bonus_fs"],
                    ).return_dict(),
                    "freegame": ConstructConditions(
                        rtp=0.95,
                        hr="x",
            ...
            "bonus_hns": {
                "conditions": {
                    "wincap": ConstructConditions(
                        rtp=0.01,
                        av_win=wincaps["bonus_hns"],
                        search_conditions=wincaps["bonus_hns"],
                    ).return_dict(),
                    "holdnspin": ConstructConditions(
                        rtp=0.95,
                        hr="x",
